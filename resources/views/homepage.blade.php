...
<head>
  ...
  <title>compass through grief</title>
...
<body class="page-index">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1 class="d-flex align-items-center">CTG</h1>
      </a>
  ...
  <section id="hero" class="hero d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
          <h2 data-aos="fade-up">Compass Through Grief</h2>
  ...
  <main id="main">
    ...
    <section id="why-us" class="why-us">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-xl-5 img-bg" style="background-image: url('import/assets/img/why-us-bg.jpeg')"></div>
            ...
            <div class="slides-1 swiper">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="item">
                    <h3 class="mb-3">We understand</h3>
                ...
                <div class="swiper-slide">
                  <div class="item">
                    <h3 class="mb-3">We are a browse away!!</h3>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="icon flex-shrink-0"><i class="fa-solid fa-user" style="color: #f57813;"></i></div>
            <div>
              <h4 class="title"><a href="#" class="stretched-link">Individual Counselling</a></h4>
              <p class="description">Connect with experienced therapists for personalized guidance and support tailored to your unique journey of grief.</p>
            </div>
          </div>
          <!-- End Service Item -->

          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="icon flex-shrink-0"><i class="bi bi-people-fill" style="color: #15a04a;"></i></div>
            <div>
              <h4 class="title"><a href="#" class="stretched-link">Support Groups and Community</a></h4>
              <p class="description">Find solace and understanding in connecting with others who share your experience. Participate in online or in-person groups focused on specific types of loss or general support.</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="icon flex-shrink-0"><i class="bi bi-collection" style="color: #d90769;"></i></div>
            <div>
              <h4 class="title"><a href="#" class="stretched-link">Grief Education</a></h4>
              <p class="description">Access comprehensive information about grief, its stages, coping mechanisms, and helpful resources tailored to different types of loss and cultural backgrounds.</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="400">
            <div class="icon flex-shrink-0"><i class="fa-solid fa-infinity" style="color: #15bfbc;"></i></div>
            <div>
              <h4 class="title"><a href="#" class="stretched-link">Peer Support and Mentorship</a></h4>
              <p class="description">Connect with individuals who have walked a similar path of grief. Find encouragement, learn from their experiences, and offer support to others in turn.</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="500">
            <div class="icon flex-shrink-0"><i class="fa-solid fa-circle-info" style="color: #f5cf13;"></i></div>
            <div>
              <h4 class="title"><a href="#" class="stretched-link">Grief Resources</a></h4>
              <p class="description">We provide articles, videos and their links respectively where you can access information which might be of help in navigating grief.</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="600">
            <div class="icon flex-shrink-0"> <i class="fa-solid fa-face-grin-beam" style="color: #1335f5;"></i></div>
            <div>
    ...
    </section><!-- Join the Online Community  -->
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
            <h3>Powerful Features provided by this website</h3>
            ...
            <div class="row gy-4">
              ...
              <div class="col-md-6">
                <div class="icon-list d-flex">
                  ...
                  <span>Tailored Support for Different Needs</span>
                </div>
              ...
              <div class="col-md-6">
                <div class="icon-list d-flex">
                  ...
                  <span>Personalized Guidance and Resources</span>
                </div>
              </div><!-- End Icon List Item-->
              ...
              <div class="col-md-6">
                <div class="icon-list d-flex">
                  ...
                  <span>Accessible and User-Friendly Technology</span>
                </div>
              </div><!-- End Icon List Item-->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              ...
              KENYA <br><br>
              <strong>Phone:</strong> +254 707813711<br>
              <strong>Email:</strong> rachealnjugush@gmail.com<br>
            </p>
